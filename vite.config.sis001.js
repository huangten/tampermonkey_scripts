...
const scriptConfigs = {
    sis001_chapter: {
        entry: 'src/sis001/chapter/chapter.js',
        userscript: {
            name: 'sis001 章节页 增强',
            author: 'YourName',
            match: [
                '*://*.sis001.com/forum/thread-*-1-1.html',
                '*://*.sis001.com/bbs/viewthread.php?tid=*',
                '*://*.sis001.com/bbs/thread-*-1-1.html'
            ],
